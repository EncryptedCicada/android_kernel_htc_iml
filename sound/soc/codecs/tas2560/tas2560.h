...
#define	TAS2560_BST_ALWAYSON_REG	TAS2560_REG(0, 0, 54)	/* B0_P0_R0x36 */

#define TAS2560_AUDIO_ENHANCER		TAS2560_REG(0, 0, 57)	/* B0_P0_R0x39 */
#define TAS2560_DR_BOOST_REG_2		TAS2560_REG(0, 0, 60)	/* B0_P0_R0x3c */
#define TAS2560_DR_BOOST_REG_1		TAS2560_REG(0, 0, 73)	/* B0_P0_R0x49 */
#define TAS2560_SOFT_MUTE			TAS2560_REG(0, 0, 78)	/* B0_P0_R0x4e */
#define TAS2560_BOOST_CTRL			TAS2560_REG(0, 0, 79)   /* B0_P0_R0X4f */
...
struct tas2560_priv {
	...
	int (*read)(struct tas2560_priv *pTAS2560,
		enum channel chn,
		unsigned int reg,
		unsigned int *pValue);
	int (*write)(struct tas2560_priv *pTAS2560,
		enum channel chn,
		unsigned int reg,
		unsigned int Value);
	int (*bulk_read)(struct tas2560_priv *pTAS2560,
		enum channel chn,
		unsigned int reg,
		unsigned char *pData, unsigned int len);
	int (*bulk_write)(struct tas2560_priv *pTAS2560,
		enum channel chn,
		unsigned int reg,
		unsigned char *pData, unsigned int len);
	int (*update_bits)(struct tas2560_priv *pTAS2560,
		enum channel chn,
		unsigned int reg,
